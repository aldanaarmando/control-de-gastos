...
@section('content')
<h1 class="text-left">Registrar ingreso</h1>
...
<div class="form-group row">
  ...
  <div class="col-10">
    <input class="form-control" type="text" name="id_ingreso" style="width:300px;height:30px">
  </div>
</div>
<div class="form-group row">
  <label for="example-search-input" class="col-2 col-form-label">Nombre de ingreso</label>
  <div class="col-10">
    <input class="form-control" type="text" name="nombre_ingreso" style="width:300px;height:30px">
  </div>
</div>
<div class="form-group row">
  <label for="example-search-input" class="col-2 col-form-label">Tipo de ingreso</label>
  <div class="col-10">
    <input class="form-control" type="text" name="tipo_ingreso" style="width:300px;height:30px">
  </div>
</div>
</div>
<div class="form-group row">
